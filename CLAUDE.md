...
- `src/` — Vite React app. Shell live: auth ([hooks/useAuth.tsx](src/hooks/useAuth.tsx) + [components/ProtectedRoute.tsx](src/components/ProtectedRoute.tsx) + [pages/SignInPage.tsx](src/pages/SignInPage.tsx)), routing ([App.tsx](src/App.tsx) — react-router v7), layout ([components/AppShell.tsx](src/components/AppShell.tsx)), global date filter ([hooks/useDateRange.tsx](src/hooks/useDateRange.tsx) + [components/DateRangePicker.tsx](src/components/DateRangePicker.tsx)), five section pages as honest placeholders. Sales (Land) panel — step 5 of 9 — design locked (see [PROGRESS.md](PROGRESS.md) 2026-05-18 design-lock entry); ready to implement in three commits (KPI strip + MoM card; plots pivot + revenue bars; quarter card + greyed cards). Supabase client at [lib/supabase.ts](src/lib/supabase.ts).
